    ...
    >
        ...
        >
          <div className="space-y-3">
            {insuranceClaims.slice(0, 4).map((claim) => (
              <div key={claim.id} className="flex items-center justify-between p-3 bg-indigo-50 rounded-lg border border-indigo-200">
                <div>
      ...
      <StandardCard title="Quick Actions" variant="compact">
        <ResponsiveGrid cols={6} gap="sm">
          ...
          <Button variant="outline" className="h-20 flex flex-col items-center justify-center hover:bg-pink-50 hover:border-pink-200">
